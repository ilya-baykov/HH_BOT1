...
class ReportGenerator:
    HEADERS = [
        "ID", "URL", "Название", "PDF URL", "PDF Путь", "Зарплата",
        "Последний опыт", "Общий опыт (мес.)", "Уровень образования",
        "Сертификаты", "Пол", "Возраст", "Регион", "Оценка 1",
        "Обоснование 1", "Оценка 2", "Обоснование 2",
        "Фамилия", "Имя", "Телефон", "Ссылки"
    ]
    ...
    def generate_report(self):
        ...
        for candidate in self.candidates:
            ...
            row = [
                ...
                ", ".join(candidate.sites_links) if candidate.sites_links else ""
            ]
